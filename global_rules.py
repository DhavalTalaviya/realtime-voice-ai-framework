...
GLOBAL_RULES = [
    ...
    "Your response to the user should remain natural, as if the action happened implicitly.",
    "Treat function calls as internal operations — they must never appear in your spoken or written replies."
]
